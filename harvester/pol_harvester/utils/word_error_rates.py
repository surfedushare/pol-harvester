...
def get_dutch_numbers():
    with open("numbers_dutch.txt") as f:
        numbers = f.readlines()
...
kaldi_jargon_hyp = ""
kaldi_jargon_hyp = cleanstring(kaldi_jargon_hyp)
print(f"cleaned jargon hyp {kaldi_jargon_hyp}")

kaldi_jargon = wer(ref, kaldi_jargon_hyp)
...
print(f" Kaldi error:  {round(kaldi, 3)}\nKaldi jargon error: {round(kaldi_jargon, 3)}")
