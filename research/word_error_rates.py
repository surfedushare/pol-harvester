...
ref = 'als jullie allebei mobiele nummers hebben en jullie zijn daarop bereikbaar dan zou die vaste lijn niet echt ja van toepassing zijn'
print("#### GOOGLE ###")
google = wer(ref,
             'als je allebei mobiele nummers hebben gezet daarop bereikbaar Dan zou die vaste lijn niet echt naam van toepassing zijn',
             True)
print("#### COMMAND ###")
command = wer(ref,
              ref,
              True)
print("#### Speechmatics ###")
speechmatics = wer(ref,
                   'als je bij mobiele nummers hebben die je daar onbereikbaar dan zou die vaste lijn niet echt van toepassing zijn',
                   True)
print("#### Kaldi ###")
kaldi = wer(ref, 'als je het allebei mobiele nummers hebben die zij daardoor bereikbaar dan zou die vaste lijn', True)

print('Google {0} \nCommand {1}\nSpeechmatics {2}\nKaldi {3}'.format(round(google, 2), round(command, 2),
                                                                     round(speechmatics, 2), round(kaldi, 2)))
